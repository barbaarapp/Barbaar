      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex flex-col items-center gap-1 mt-2">
            ...
            <div className="px-2 py-0.5 bg-brand/5 border border-brand/10 rounded-full flex items-center gap-1.5 mt-1">
              <div className="w-1 h-1 rounded-full bg-brand" />
              <span className="text-[7px] font-black text-brand uppercase tracking-widest leading-none">Verified Barbaar.org Auth Domain</span>
            </div>
          </div>
        </div>
