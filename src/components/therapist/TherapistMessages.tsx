        ...
        <div className="tc-chatfeed">
          {selectedClient ? (
            <>
              ...
              {/* Privacy Protection Banner for Therapist Chat */}
              <div className="bg-[#1b2b24] text-[#e6cca0] px-4 py-1.5 flex items-center justify-between text-[11px] border-b border-[#c8a97e]/20 shadow-inner flex-shrink-0">
