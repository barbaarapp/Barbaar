...
export const UI_TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  "Need financial support for your therapy?": {
    en: "Need financial support for your therapy?",
    so: "Ma u baahan tahay taageero dhaqaale oo daryeelkaaga ah?",
  },
  "Barbaar's Financial Relief program offers Somali youth, students, and low-income individuals up to 40% off sessions. Apply upfront and secure pre-approval.": {
    en: "Barbaar's Financial Relief program offers Somali youth, students, and low-income individuals up to 40% off sessions. Apply upfront and secure pre-approval.",
    so: "Barnaamijka Taageerada Dhaqaalaha ee Barbaar wuxuu dhalinyarada Soomaaliyeed, ardayda, iyo dadka dakhligoodu hooseeyo siinayaa ilaa 40% dhimis kulamada ah. Codso hadda si aad u hesho ogolaansho hore.",
  },
  "Apply for Relief": { en: "Apply for Relief", so: "Codso Taageerada" },
  "Request Financial Relief": { en: "Request Financial Relief", so: "Codso Taageero Dhaqaale" },
  "Barbaar is committed to mental health equity. Request upfront pre-approval to secure up to 40% relief discount on counseling sessions.": {
    en: "Barbaar is committed to mental health equity. Request upfront pre-approval to secure up to 40% relief discount on counseling sessions.",
    so: "Barbaar waxay u taagan tahay sinnaanta daryeelka caafimaadka maskaxda. Codso ogolaansho hore si aad u hesho ilaa 40% dhimis kulamadaada.",
  },
  "Full Name": { en: "Full Name", so: "Magacaaga oo Buuxa" },
  "Enter your full name": { en: "Enter your full name", so: "Geli magacaaga oo buuxa" },
  "Gmail Address": { en: "Gmail Address", so: "Cinwaanka Gmail" },
  "WhatsApp Number": { en: "WhatsApp Number", so: "Lambarka WhatsApp" },
  "Qualifying Category": { en: "Qualifying Category", so: "Qaybta Ku Habboon" },
  "Somali Youth": { en: "Somali Youth", so: "Dhalinyarada Soomaaliyeed" },
  "Student": { en: "Student", so: "Arday" },
  "Unemployed": { en: "Unemployed", so: "Shaqo La'aan / Dakhli Hoose" },
  "Barbaar Member": { en: "Barbaar Member", so: "Xubin Barbaar" },
  "Justification Statement": { en: "Justification Statement", so: "Faahfaahin Kooban" },
  "Briefly describe your current situation. It helps our administrators review and approve your application.": {
    en: "Briefly describe your current situation. It helps our administrators review and approve your application.",
    so: "Si kooban u sharax xaaladdaada. Waxay ka caawinaysaa maamulka inuu si dhakhso ah u ansixiyo codsigaaga.",
  },
  "Submit Request": { en: "Submit Request", so: "Gudbi Codsiga" },
  "Submit Application": { en: "Submit Application", so: "Gudbi Codsiga" },
  "Application Submitted!": { en: "Application Submitted!", so: "Codsigaagii waa la gudbiyey!" },
  "We have received your financial relief request. Our care team will review and approve it within 24 hours.": {
    en: "We have received your financial relief request. Our care team will review and approve it within 24 hours.",
    so: "Waan helnay codsigaaga taageerada dhaqaale. Kooxdeena daryeelku waxay ku eegi doonaan 24 saacadood gudahood.",
  },
  "APPROVED": { en: "APPROVED", so: "LA ANSIXIYEY" },
  "40% Financial Relief Active": { en: "40% Financial Relief Active", so: "40% Dhimis Taageero ah ayaa Furan" },
  "Your pre-approved 40% relief discount is automatically applied to all therapist bookings.": {
    en: "Your pre-approved 40% relief discount is automatically applied to all therapist bookings.",
    so: "Dhimistaada 40% ah ee la ansixiyey waxay si toos ah ugu dabbaqmi doontaa dhammaan ballamaha dhaqaatiirta.",
  },
  "Days": { en: "Days", so: "Maalmood" },
  "Hours": { en: "Hours", so: "Saacadood" },
  "Mins": { en: "Mins", so: "Daqiiqo" },
  "Secs": { en: "Secs", so: "Ilbiriqsi" },
  "Valid for next 72 hours": { en: "Valid for next 72 hours", so: "Waxay shaqaynaysaa 72-ka saac ee soo socda" },
  "Book Session with 40% Off": { en: "Book Session with 40% Off", so: "Qabso Kulan 40% Dhimis ah" },
